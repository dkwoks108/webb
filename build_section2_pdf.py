#!/usr/bin/env python3
"""
Section 2: Logical Reasoning - 1000 MCQ PDF Generator
...
from s2_q001_200 import get_questions as q1
from s2_q201_400 import get_questions as q2
from s2_q401_600 import get_questions as q3
from s2_q601_800 import get_questions as q4
from s2_q801_1000 import get_questions as q5
from s2_supplement import get_questions as q6
...
class QuizPDF(FPDF):
    ...
    def header(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 7, "Quiz-A-Thon  |  Section 2: Logical Reasoning  |  1000 MCQs", align="C")
...
def build_pdf():
    ...
    pdf.cell(0, 12, "SECTION 2", align="C")
    pdf.ln(12)
    pdf.set_font("Helvetica", "", 16)
    pdf.cell(0, 10, "Logical Reasoning", align="C")
    pdf.ln(14)
    ...
    # ─── Save ───
    output = "/workspaces/webb/Section2_Logical_Reasoning_1000_MCQs.pdf"
    pdf.output(output)
